...
List<NavItemModel> navItemList = [
  ...
  NavItemModel(svgPath: AppIcon.chatbot, label: 'Chatbot'),
  NavItemModel(svgPath: AppIcon.article, label: 'Articles'),
  NavItemModel(svgPath: AppIcon.profile, label: 'Profile'),
];
