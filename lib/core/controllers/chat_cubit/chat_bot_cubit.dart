...
import 'package:health_guard/core/helpers/dio_helper.dart';
import 'package:health_guard/features/chatbot/data/model/message_model.dart';
...
Stream<List<MessageModel>>get messagesStream=>_messageStreamController.stream;
  Future<void> sendMessage() async {
    ...
    try {
      emit(ChatBotLoading());
      final response = await DioHelper.send(sendMessage as String  
          , data: {
