...
import 'package:health_guard/features/Diagnostics/presentation/views/diabetes_view.dart';
import 'package:health_guard/features/Diagnostics/presentation/views/disease_detection_view.dart';
import 'package:health_guard/features/Diagnostics/presentation/views/widgets/diabetes_view_body.dart';
import 'package:health_guard/features/auth/data/repos/auth_repo_impl.dart';
...
import 'package:health_guard/features/auth/presentation/views/forget_password_view.dart';
import 'package:health_guard/features/auth/presentation/views/new_password_view.dart';
import 'package:health_guard/features/auth/presentation/views/sign_in_view.dart';
import 'package:health_guard/features/auth/presentation/views/sign_up_view.dart';
import 'package:health_guard/features/auth/presentation/views/verify_email_view.dart';
import 'package:health_guard/features/home/presentation/views/home_view.dart';
import 'package:health_guard/features/onBoarding/presentation/manager/onBoarding/on_boarding_cubit.dart';
import 'package:health_guard/features/onBoarding/presentation/views/on_boarding_view.dart';
